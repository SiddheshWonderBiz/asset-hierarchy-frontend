...
const Signup = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await signup(username, password, "Viewer");
    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-blue-50 to-indigo-100 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600 text-lg">Join the Asset Hierarchy System</p>
        </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <div className="ml-1 flex items-center space-x-3 text-xs">
                <span className={`flex items-center ${password.length >= 6 ? 'text-green-600' : 'text-gray-400'}`}>
                  <div className={`w-2 h-2 rounded-full mr-1 ${password.length >= 6 ? 'bg-green-500' : 'bg-gray-300'}`}></div>
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-xl p-4">
              <div className="flex items-center">
                ...
                <div>
                  <h4 className="text-sm font-semibold text-blue-800">Viewer Account</h4>
                  <p className="text-xs text-blue-600">You'll have read-only access to view hierarchy and signals</p>
                </div>
              </div>
            </div>
